...
fn snapshot_strict_mode_text_output() {
    ...
    let old_spec = soroban_upgrade_safeguard::spec::ContractSpec::from_entries(&old_meta.spec);
    let new_spec = soroban_upgrade_safeguard::spec::ContractSpec::from_entries(&new_meta.spec);
